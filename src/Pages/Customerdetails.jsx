          ...
          <div className="max-w-xl w-full mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between mt-10 gap-6">
              ...
              <button
                ...
                className="w-full md:w-auto bg-[#F59115] hover:bg-orange-600 text-white font-semibold py-4 px-10 rounded-lg transition-transform active:scale-95 cursor-pointer"
              >
